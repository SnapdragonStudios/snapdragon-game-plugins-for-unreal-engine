...
class FSGSRSU final : public ISpatialUpscaler
{
public:
	FSGSRSU(ESGSRMode InMode, TArray<TSharedPtr<FSGSRData>> InViewData);

	// ISpatialUpscaler interface
	const TCHAR* GetDebugName() const override { return TEXT("FSGSRSU"); }
