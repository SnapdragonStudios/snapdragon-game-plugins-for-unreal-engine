...
2. [Fork](https://github.com/SnapdragonGameStudios/snapdragon-game-plugins-for-unreal-engine) and clone the repository.
...
6. Push to your fork and [submit a pull request](https://github.com/SnapdragonGameStudios/snapdragon-game-plugins-for-unreal-engine) from your branch to `main`.
