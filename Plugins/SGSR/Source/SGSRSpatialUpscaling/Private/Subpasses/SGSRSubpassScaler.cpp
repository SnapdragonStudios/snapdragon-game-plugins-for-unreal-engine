...
static TAutoConsoleVariable<bool> SGSR_HalfPrecisionCVar(
	...
	0,//#HalfPrecisionNotSupported: half-precision often speeds processing time with little or no additional noticeable artifacts, but is not supported until UE5.0
...
{
	HalfPrecisionCVarSetToFalse(Var);//#HalfPrecisionNotSupported
}
