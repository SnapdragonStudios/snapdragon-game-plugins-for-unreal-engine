...
void FGSRTUModule::StartupModule()
{
	...
	ApplyCVarSettingsFromIni(TEXT("/Script/GSRTUModule.GSRSettings"), *GEngineIni, ECVF_SetByProjectSetting);
...
ITemporalUpscaler* FGSRTUModule::GetTU() const
{
...
ICustomStaticScreenPercentage* FGSRTUModule::GetCustomSP() const
{
	return TemporalUpscaler.Get();
}
