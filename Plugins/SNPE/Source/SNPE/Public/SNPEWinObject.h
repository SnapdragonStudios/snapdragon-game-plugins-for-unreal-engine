...
class SNPE_API FSNPEWinObject: public ISNPEObject
{
public:
	FSNPEWinObject(const FString& Model, bool usintInitCaching, RuntimeMode runtime, const TArray<FString>& UDOs);
	~FSNPEWinObject() {}
...
protected:
	...
	bool Valid = false;
	static FString CDSP_library_path;

	bool Initialize();
	//TODO-ccastril: move to WindowsPlatformProcess.h
	FString GetNativeLibraryDir();
